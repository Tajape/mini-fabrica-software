...
export default function Lancamentos() {
  ...
  const handleSalvar = async (e) => {
    e.preventDefault();
    if (formData.horas <= 0)
      return alert("As horas devem ser maiores que zero!");
      ...
      <header className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            Gestão de horas e produtividade.
          </p>
        </div>
        <button
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-800">
            {lancamentosFiltrados.map((l) => (
              <tr
                key={l.id}
                className="text-slate-300 hover:bg-slate-800/30 transition-all group"
              >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <form
            ...
            className="bg-[#1e293b] w-full max-w-md rounded-2xl border border-slate-800 p-6 space-y-4 animate-in zoom-in-95 duration-200"
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <select
                  required
                  className="w-full bg-[#0f172a] border border-slate-800 rounded-xl py-3 px-4 text-white outline-none focus:ring-2 focus:ring-indigo-500/50"
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#0f172a] border border-slate-800 rounded-xl py-3 px-4 text-white"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    type="date"
                    required
                    className="w-full bg-[#0f172a] border border-slate-800 rounded-xl py-3 px-4 text-white text-sm"
                    value={formData.data}
                    onChange={(e) =>
              ...
              <div>
                ...
                >
                  <option value="corretiva">
                    Corretiva (Nova funcionalidade)
                  </option>
                  <option value="evolutiva">
                    Evolutiva (Correção de bugs)
                  </option>
                  <option value="implantacao">
                    Implantação (Setup/Publicação)
                  </option>
                  <option value="legislativa">
                    Legislativa (Adequação a lei/ Impostos)
                  </option>
                </select>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#0f172a] border border-slate-800 rounded-xl py-3 px-4 text-white min-h-[100px]"
            ...
            <button
              type="submit"
              className="w-full bg-indigo-600 py-4 rounded-xl text-white font-bold shadow-lg shadow-indigo-500/20 hover:bg-indigo-700 transition-all mt-2"
            >
